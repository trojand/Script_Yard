...
parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter,
                                     ...
                                     "There are easier and better alternatives to this script such as Cyberchef's \"Extract Email Addresses\" Recipe (General use) or dafthack's \"Get-GlobalAddressList\" function in MailSniper (Exchange/o365 use) although processing a REALLY BIG blob of text is better using this.\n\n"+
                                     "Example commands:\n" +
...
parser.add_argument("--output", dest="output", required=False, type=str, default="blob_email_addresses_output.txt",help="Output file.")
