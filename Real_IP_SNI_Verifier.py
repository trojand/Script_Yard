...
def main():
    ...
    parser = argparse.ArgumentParser(formatter_class=RawTextHelpFormatter,
                                     ...
                                     "Example commands:\n" +
                                     "$ python3 Real_IP_Tracker.py --domain maps.google.com --path /landing/transit/js/transit_directions.min.js --ip 216.58.207.46 --keyword \"mapTypeId: google.maps.MapTypeId.ROADMAP\" --range-start 46 --range-end 49\n" +
                                     "$ python3 Real_IP_Tracker.py --domain maps.google.com --path /landing/transit/js/transit_directions.min.js --ip 216.58.207.46 --keyword \"mapTypeId: google.maps.MapTypeId.ROADMAP\"")
